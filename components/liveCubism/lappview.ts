...
export class LAppView {
   ...
   */
  public release(): void {
    if (!this._gear || !this._back || !gl) {
      console.log("could not release, somthing is null");
      return;
    }
  ...
  public render(): void {
    ...
    live2DManager.setViewMatrix(this._viewMatrix as CubismViewMatrix);
  ...
  public transformViewX(deviceX: number): number | undefined {
    if (!this._deviceToScreen || !this._viewMatrix) {
      return undefined;
    }
